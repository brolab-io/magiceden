...
AFRAME.registerSystem("physx", {
  ...
  tock(t, dt) {
    ...
    this.scene.simulate(
      THREE.Math.clamp((dt * this.data.speed) / 1000, 0, 0.03 * this.data.speed),
      true
    );
...
AFRAME.registerComponent("physx-body", {
  ...
  createConvexMeshGeometry(mesh, rootAncestor) {
    ...
    return new PhysX.PxConvexMeshGeometry(
      ...
      new PhysX.PxConvexMeshGeometryFlags(PhysX.PxConvexMeshGeometryFlag.eTIGHT_BOUNDS.value)
    );
  },
  ...
  createShapes(physics) {
    ...
    Util.traverseCondition(
      ...
      (o) => {
        ...
        if (o.el && !o.el.object3D.visible && !o.el.hasAttribute("physx-hidden-collision"))
          return false;
...
AFRAME.registerComponent("physx-joint-driver", {
  ...
  setJointDriver() {
    ...
    this.joint.setDrivePosition(
      { translation: { x: 0, y: 0, z: 0 }, rotation: { w: 1, x: 0, y: 0, z: 0 } },
      true
    );
